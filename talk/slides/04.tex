...
\begin{frame}[t]{Monte Carlo is an embarrassingly parallel algorithm}
  \myonly{1}{\includegraphics[height=0.6\paperheight]{graphics/monte_carlo_description_0.pdf}}
  \myonly{2}{\includegraphics[height=0.6\paperheight]{graphics/monte_carlo_description_1.pdf}}
  %\myonly{3}{\includegraphics[height=0.6\paperheight]{graphics/monte_carlo_description_2.pdf}}
  %\myonly{4}{\includegraphics[height=0.6\paperheight]{graphics/monte_carlo_description_3.pdf}}
%
%  \begin{columns}[T]
%
