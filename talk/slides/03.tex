...
\begin{frame}[t]{Finding the ASE-temperature equilibrium}
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \myonly{1}{\includegraphics[width=.5\paperwidth]{graphics/ASE_temperature_equilibrium1.png}}
      \myonly{2}{\includegraphics[width=.5\paperwidth]{graphics/ASE_temperature_equilibrium2.png}}
      \myonly{3-4}{\includegraphics[width=.5\paperwidth]{graphics/ASE_temperature_equilibrium3.png}}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{itemize}
          \myuncover{2}{4}{
