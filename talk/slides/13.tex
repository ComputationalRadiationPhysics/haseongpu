...
\begin{frame}{Simulation has a strong agreement with experimental data}
  \begin{columns}[T]
    ...
    \begin{column}{.5\textwidth}
      \myonly{1}{
        \includegraphics[width=0.5\paperwidth]{graphics/benchmark_only_experiment.png}
      }
      \myonly{2}{
        \includegraphics[width=0.5\paperwidth]{graphics/benchmark_with_simulation.png}
      }
      \myuncover{1}{3}{
        \textbf{table: experimental setup}
      }
    \end{column}
