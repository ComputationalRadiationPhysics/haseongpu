...
\begin{frame}[t]{Sample points can be distributed in a cluster}
  \begin{columns}[T]
    ...
    \begin{column}{.5\textwidth}
      \myonly{2}{\includegraphics[width=0.5\paperwidth]{graphics/load_balancing_MPI_0.pdf}}
      \myonly{3}{\includegraphics[width=0.5\paperwidth]{graphics/load_balancing_MPI_1.pdf}}
      \myonly{4-5}{\includegraphics[width=0.5\paperwidth]{graphics/load_balancing_MPI_2.pdf}}
    \end{column}
