...
$10^5$ rays per sample point (see Figure \ref{graphic:importance}). 
Then, the number of rays per sample point was increased for the simulation
without importance sampling.
The more rays are simulated, the smaller is $\Phi_{ASE~diff}$, which 
means that the results get closer and therefore the simulation
with importance sampling reaches same results with less
...
be sampled with a higher resolution. To assess the precision
