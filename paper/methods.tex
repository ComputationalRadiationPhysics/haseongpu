...
\begin{figure}[H]
  ...
  \caption{One of 200 blocks to calculate $\Phi_{ASE}$. Each
  thread calculates serveral traces sequentially.}
...
\end{figure}
    ...
    point~$s_i$, a kernel consisting of a grid of maximal 200 CUDA
    blocks is spawned. Each of those blocks contains 128 CUDA threads.
