...
Each Monte Carlo experiment (see \ref{eq:monte_carlo_ase}), calculates the $\Phi_{ASE}(\vec{r}_0)$ 
...
Consider having $n$ GPUs on a node available, 
$n$ \emph{pthreads} are spawned on the host. A GPU and a
