...
Interestingly, in this particular case, monochromatic simulations without reflections (d) show very similar,
but smaller, gain values when compared to the polychromatic simulation with reflections (c). 
Adding reflections (e) overestimates the ASE impact
in the monochromatic case and consequently shows a too small gain value. This is mainly attributed to
reflected ray paths that are longer in average, especially due to total internal reflection.
...
Consequently, a simulation configuration with reflection and polychromatic spectrum (c) enabled 
matches the measured values (b) within the measurement uncertainty and validates our simulation approach.
