...
wavelength. Figure \ref{graphic:benchmark_4_timeslices} shows
varying simulation configurations and their influence on the
gain development over time.
...
\textbf{TODO} describe sliced gain medium
...
\end{figure}
\textbf{TODO} How to calc dndt ASE ?\\
