...
Carlo integration. For a single wavelenght \textbf{(TODO polychromatic)}, the equation is rewritten as a sum:
\begin{equation}
...
This process is iterated for each prism on the path between $r_{,u}i$ and the
...
prism. \textbf{TODO Polychromatic $\sigma_e \sigma_a$ .}
