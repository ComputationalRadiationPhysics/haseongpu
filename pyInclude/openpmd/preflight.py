...
def check_provider(args: argparse.Namespace) -> tuple[dict[str, object], dict[str, str], list[str], list[str]]:
    errors: list[str] = []
    warnings: list[str] = []
    ...
    return python_info, cmake_info, errors, warnings
...
def print_report(
    ...
    if errors and "log" in cmake_info:
...
def main(argv: list[str] | None = None) -> int:
    ...
    python_info, cmake_info, errors, warnings = check_provider(args)
    print_report(args, python_info, cmake_info, errors, warnings)
