...
SIMULATION_ATTRIBUTE_SPECS = (
    ...
    ExtensionAttributeSpec("propagationMode", "propagation_mode", "str", unitDimension=unitDimension.dimensionless),
    ExtensionAttributeSpec("forwardRayCount", "forward_ray_count", "int", unit="count", unitDimension=unitDimension.maxRaysPerSample),
    ExtensionAttributeSpec("forwardRayLength", "forward_ray_length", "float", unit="m", unitDimension=unitDimension.length),
